...
ufw allow 33300/tcp 
ufw allow 9999/tcp 
wget https://github.com/duality-solutions/Dynamic/releases/download/v2.4.0.0/Dynamic-2.4.0.0-Linux-x64.tar.gz
tar -xvzf Dynamic-2.4.0.0-Linux-x64.tar.gz
cp /root/dynamic-2.4.0/bin/* /usr/local/bin/
cd ~
mkdir /root/.dynamic
